const INFO = {
    ...
    socials: {
        github: "https://github.com/Aleks38",
        linkedin: "https://www.linkedin.com/in/alexy-da-silva-54499b229",
        stackoverflow: "https://stackoverflow.com/users/25042396/aleks",
    },

    homepage: {
        title: "Alexy Da Silva, étudiant en informatique.",
        description:
            "Curieux de nature, je me suis donc orienté vers le développement informatique pour en comprendre un peu plus. Ayant bien d'autres passions comme le sport automobile ou le ski, j'ai décidé de faire du développement mon métier. Toujours envie d'apprendre, j'ai eu la chance de découvrir de nombreux framework tout au long de mes formations comme vous pourrait observer dans la page projet.",
    },
    ...
    projects: [
        {
            title: "eTicket",
            description:
                "J'ai participé à la refonte complète de l'application eTicket qui est proposé par QIIS. Le framework choisi est Flutter avec l'utilisation d'une Clean Architecture.",
            logo: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/flutter/flutter-original.svg",
            linkText: "Voir site Web",
            link: "https://www.eticket.qiis.fr/",
            techno: "Flutter",
        },
...

        {
            ...
            description:
                "Projet de gestion immobilière réalisé en C# .NET avec l'utilisation du pattern observer observable et une architecture MVC.",
            logo: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/csharp/csharp-original.svg",
            linkText: "Voir repository",
            link: "https://github.com/Aleks38/Gestion-Immobiliere.git",
            techno: "C#",
        },
